...
pub use node::{LEAF_FLAG, is_leaf, leaf_value, make_leaf, child_count};
pub use voxel::{Voxel, ColorPalette};
...
impl Level {
  pub fn new(layer: LayerType, child_bits: u8) -> Self {
    Self {
      occupancy:      Vec::new(),
      ...
      children:       BitpackedArray::new(child_bits),
      dedup:          HashMap::new(),
    }
  }
  ...
  pub fn insert(&mut self, layer: LayerType, occupancy: u64, voxel_count: u32, children: &[u32]) -> u32 {
    todo!()
  }
}
