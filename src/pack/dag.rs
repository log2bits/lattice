#![allow(unused)]
use crate::lattice::{Lattice, SectionConfig, Level};
...
pub fn insert_geometry_dag(level: &mut Level, occupancy: u64, voxel_count: u32, children: &[u32]) -> u32 {
  todo!()
}

// Inserts a batch of children into a MaterialDag level, deduplicating on
// both occupancy and children (geometry + material hash).
pub fn insert_material_dag(level: &mut Level, occupancy: u64, children: &[u32]) -> u32 {
  todo!()
}
